...
class rama(models.Model):
    ...
    def __str__(self):
        return self.nombrerama

class equipo(models.Model):
    nombreequipo = models.CharField(max_length=30)
    pertenenciarama = models.ForeignKey(rama,on_delete=models.CASCADE)
    pertenenciacategoria = models.ForeignKey(categoria,on_delete=models.CASCADE)
    pertenenciadeporte = models.ForeignKey(deporte,on_delete=models.CASCADE)
...
class estadisticas(models.Model):
    ...
    def __str__(self):
        return self.pertenenciacategoria.nombrecategoria
